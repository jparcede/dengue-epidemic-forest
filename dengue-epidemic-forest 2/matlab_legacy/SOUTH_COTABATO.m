...
%% SHOULD BE NOTED THAT THIS CODE RUNS SEMI-MANUALLY (HAS TO BE RUN FOR EACH YEARS)
%% THE RELATED CODE IS: 
...
[num,txt,raw] = xlsread('South_Cotabato_General Santos.xlsx','2016');
